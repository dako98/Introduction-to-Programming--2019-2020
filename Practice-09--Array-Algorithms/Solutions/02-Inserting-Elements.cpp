 ...
 * @file 02-Inserting-Elements.cpp
 * @brief Solution for Problem 02 from Practice-09
 * @author Alexander Dimitrov
 *
 * Problem:
 *  Write a program that after every even number in an array
 *  inserts the sum of all odd numbers before the current.
 */
