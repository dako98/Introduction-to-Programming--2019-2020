 ...
 * @file 05-Sort-By-Frequency.cpp
 * @brief Solution for Problem 05 from Practice-09
 * @author Alexander Dimitrov
 *
 * Problem:
 *  Write a program that sorts a given array with
 *  elements from the range [0, 100] by frequency.
 */
