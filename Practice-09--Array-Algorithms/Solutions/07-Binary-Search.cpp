 ...
 * @file 07-Binary-Search.cpp
 * @brief Solution for Problem 07 from Practice-09
 * @author Dako Dimov
 *
 * Problem:
 *  Write a program that finds a number in an array
 *  using the least amount of comparisons.
 */
