 ...
 * @file Problem-1.cpp
 * @brief Solution for Sample Problem 1 from Exam-Preparation-02
...
/*  Prints jagged matrix given the number of rows and an array containing the number of elements on each row
 *  ! Note that since we won't be modifying the matrix we pass it as const int * const *
...
int main()
{
    ...
    // Helper array where each element will be how many numbers have sum of digits equal to the index in the array
